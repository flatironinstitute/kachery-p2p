...
def _find_file(uri: str, timeout_sec: float) -> Tuple[Iterable[dict], Response]:
    ...
    sock, req = _http_post_json_receive_json_socket(url, dict(fileKey=file_key, timeoutMsec=timeout_sec * 1000), headers=headers)
    return sock, req
