...
export default class DownloadOptimizerJob {
    ...
    #isRunning = false
    #isComplete = false
    constructor(private fileKey_: FileKey, private fileSize_: ByteCount | null, private label_: string, private findProviders: FindProvidersFunction, private createDownloader: CreateDownloaderFunction) {
    }
    fileKey() {
